...
public class testcode {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Keywords collected Successfully: " + keywords);
        ...
        // find the longest and shortest option
        ...
        for (String keyword : keywords) {
            ...
            // Move the cursor to trigger every suggestion
        ...
        // Save changes to the worksheet data
        try {
